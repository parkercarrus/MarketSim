...
public:
    ...
    Order make_order(double market_price, double best_bid, double best_ask, const std::vector<MarketTick>& tick_history, int timestep) override {
        ...
        return Order{order_type, price, trader_id, timestep, get_type(), position_size};
    }
