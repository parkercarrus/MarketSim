...
from marketsim.core.orderbook import OrderBook, Order
from marketsim.traders import make_trader
...
class Market:
    def __init__(self, config):
        ...
        self._obs_hist = max(
            5,
            max((getattr(t, "long_lb", 0) + 2) for t in self.traders),
